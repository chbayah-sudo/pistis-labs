...
This project was generated using `flash init`. The `pistis-workers` placeholder is automatically replaced with your actual project name during initialization.
